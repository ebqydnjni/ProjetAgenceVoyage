...
<div class="dashboard">
  ...
  <div class="dashboard-format-container">
    <div class="dashboard_box">
      <div class="dashboard_item">
        <a href="clientBillets.php" class="dashboard-item_link">
  ...
  <div class="dashboard-format-container">
    <div class="dashboard_box">
      <div class="dashboard_item">
        <a href="clientReservations.php" class="dashboard-item_link">
          <div class="dashboard-item_bg"></div>
          <div class="dashboard-item_title">
  ...
  <div class="dashboard-format-container">
    <div class="dashboard_box">
      <div class="dashboard_item">
        <a href="clientProfile.php" class="dashboard-item_link">
          <div class="dashboard-item_bg"></div>
          <div class="dashboard-item_title">
